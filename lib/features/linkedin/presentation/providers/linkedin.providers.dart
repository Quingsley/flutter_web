...
import 'package:portfolio/features/linkedin/data/repositories/linkedin.repository.dart';
import 'package:portfolio/features/linkedin/presentation/viewmodels/linkedin.viewmodel.dart';

final linkedInProvider = Provider<ILinkedInRepository>(
    (ref) => LinkedInRepository(ref) /*MockLinkedInRepository()*/);
