...
import 'package:portfolio/features/web/data/repositories/web.repository.dart';
import 'package:portfolio/features/web/presentation/viewmodels/web_page.viewmodel.dart';

final webPageRepositoryProvider = Provider<IWebRepository>(
    (ref) => WebRepository(ref) /*MockWebRepository()*/);
